...
from .forms import ContactForm, NewsletterForm, CollaborationProposalForm
...
class CodeTogetherView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        testimonials = Testimonial.objects.filter(is_featured=True).order_by(
            "order", "-created_date"
        )
...
class PrivacyPolicyView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["meta_description"] = (
            "Privacy Policy for Roshan Damor's portfolio website. Learn how we collect, use, and protect your personal information."
        )
        return context
...
class TermsOfServiceView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["meta_description"] = (
            "Terms of Service for Roshan Damor's portfolio website. Please read these terms carefully before using our services."
        )
        return context
